...
| [Theme presets](configuration/themes.md)                  | Shipped built-in theme preset catalog: selection keys and aliases, 20 dark + 10 light preset families, provenance, unsupported custom themes, and open questions (landed in `bitty` `CTX-0350`).                                                                                                                         |
