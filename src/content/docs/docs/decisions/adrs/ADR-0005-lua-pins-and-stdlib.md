...
- [ ] **E6 — Supply-chain attestation:** `cargo vet` findings, `cargo audit` clean, license table MIT and Apache-2.0 only, CodeQL SARIF, `cargo geiger` summary stored under `recordings/evidence/` or `docs/security/`.
