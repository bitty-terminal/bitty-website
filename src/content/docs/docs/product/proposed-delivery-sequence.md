...
- Status: draft research record. This document remains a **proposal** retained
  ...
  separately accepted artifact, [ADR 0008](../decisions/adrs/ADR-0008-headless.md),
...
| IPC                            | `bitty-ipc`                                           | Draft std-only stub; bounded framing/channels/stdio. Wire/auth/scopes are accepted at the design level in the [IPC and Agent RFC](../specifications/ipc-agent-rfc.md), which closes [OQ-018](../decisions/open-questions.md). Implementation is recorded as `Implemented` at `be3bdb4`, but not yet `Verified`, release-ready, or user-ready.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
accepted only by [ADR 0008](../decisions/adrs/ADR-0008-headless.md). This
...
This staging was offered to [OQ-020](../decisions/open-questions.md) as a
candidate and is deferred to post-v1.0 with a trust-boundary gate only because
[ADR 0008](../decisions/adrs/ADR-0008-headless.md) accepts that disposition. The
trust-boundary half requires analysis against the [threat model](../security/threat-model.md)
