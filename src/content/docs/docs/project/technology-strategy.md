...
| Primary configuration language | Lua                                                        | Accepted working direction; model, layer, merge, and reload contracts accepted in [Configuration Model RFC](../projects/bitty/specifications/configuration-model-rfc.md) (OQ-010); Lua runtime, sandbox, and diagnostics contracts accepted in [Lua Runtime RFC](../projects/bitty/specifications/lua-runtime-rfc.md) (OQ-009, 2026-08-27) |
...
| --------------------- | --------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Lua runtime           | Lua 5.4 plus vendored `mlua`                                    | Sandbox, restricted-library, and diagnostics contracts accepted in [Lua Runtime RFC](../projects/bitty/specifications/lua-runtime-rfc.md) (OQ-009, 2026-08-27); exact pins, audit, and GC/budget tuning remain Open under OQ-030, OQ-031, OQ-032                                                                                 |
| Primary configuration | `init.lua` to declarative `ConfigPlan`                          | Accepted: schema, merge, reload, and project-trust contracts defined in [Configuration Model RFC](../projects/bitty/specifications/configuration-model-rfc.md) (OQ-010); Lua runtime, sandbox, and diagnostics contracts accepted in [Lua Runtime RFC](../projects/bitty/specifications/lua-runtime-rfc.md) (OQ-009, 2026-08-27) |
...
- Accepted: [Terminal State RFC](../projects/bitty/specifications/terminal-state-rfc.md)
