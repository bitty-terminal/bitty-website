...
| [UI Extensibility Architecture](ui-extensibility-architecture.md)                       | OQ-043, OQ-044, OQ-049 (candidate review; OQ-041/OQ-045 accepted in RFC-0001) | Draft    |
...
| [AI Architecture](ai-architecture.md)                                       | post-1.0, OQ-018 contracts plus OQ-057..OQ-071 directions      | Draft  | none                                                                                                                                                                                                     | P2 — deferred post-1.0, lowest priority |
...
[ADR 0010](../../../decisions/adrs/ADR-0010-plugin-host-runtime-acceptance.md), which
