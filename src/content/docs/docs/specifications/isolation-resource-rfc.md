...
| RC-11 | Plugin persistent store quota           | each plugin                            | 256 KiB persisted per plugin (`STORE_QUOTA_BYTES`); at most 8 KiB per serialized value (`STORE_MAX_VALUE_BYTES`), depth at most 8, at most 1024 nodes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | refusal above quota (`E_STORE_QUOTA`, `budget` class) or invalid value (`E_STORE_VALUE_INVALID`, `validation` class); no eviction and no partial write; the store survives generation disposal per the [Plugin API v1 Lua Surface RFC](plugin-api-v1-lua-surface-rfc.md)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
